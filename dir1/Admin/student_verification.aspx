<%@ Page Title="" Language="C#" MasterPageFile="~/dir1/Admin/dashboard.master" AutoEventWireup="true" CodeFile="student_verification.aspx.cs" Inherits="dir1_Admin_Default2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function load_data() {
            ...
            $("#stu_tbody").fadeOut(1);
            var temp = "../TPO/load_data.aspx?tb=signup&sortby="+type1;
            //alert(temp);
