...
<body>
	...
	<div id="header-wrapper" class="header-slider">
		<header class="clearfix">
			<div class="logo">
				<img src="design/img/bvm.png" height="200" width="200" alt="" />
			</div>
			<div class="container">
				<div class="row">
					<div class="span12">
						<div id="main-flexslider" class="flexslider">
							<ul class="slides">
								...
								<li>
									<p class="home-slide-content">
										<strong>An Autonomous</strong> Institute
									</p>
								</li>
								<li>
									<p class="home-slide-content">
		...
		<div class="container">
			<div class="row">
				...
				<div class="span6 aligncenter flyRight">
                    <asp:Image ID="Image1" runat="server" ImageUrl="design/img/job.png" Height="200" Width="200" />
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="span3">
					<div class="home-post">
						...
						<div class="post-meta">
							...
							<span class="tags">ICWSTCSC2018</span>
						</div>
						<div class="entry-content">
							<p>
                            <asp:Image ID="Image3" runat="server" ImageUrl="design/img/Placement%20Summary.jpg" Height="200" Width="300" />
							</p>
						</div>
					</div>
				</div>
				<div class="span3">
					<div class="home-post">
						...
						<div class="post-meta">
							<i class="icon-file icon-2x"></i>
							<span class="date">June, 2018</span>
							<span class="tags">NPTEL Certi</span>
						</div>
						<div class="entry-content">
							<p>
                            <asp:Image ID="Image4" runat="server" ImageUrl="design/img/NPTEL_Certi.jpg" Height="200" Width="300" />
							</p>
						</div>
					</div>
				</div>
				<div class="span3">
					<div class="home-post">
						...
						<div class="entry-content">
							<p>
                            <asp:Image ID="Image5" runat="server" ImageUrl="design/img/ICWSTCSC2018.jpg" Height="200" Width="300" />
							</p>
						</div>
					</div>
				</div>
                <div class="span3">
					<div class="home-post">
						...
						<div class="entry-content">
							<p>
                            <asp:Image ID="Image2" runat="server" ImageUrl="design/img/ICWSTCSC2018_4.jpg" Height="200" Width="300" />
							</p>
						</div>
					</div>
				</div>
