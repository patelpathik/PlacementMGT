...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <script type="text/javascript" src="../../jquery.min.js"></script>
    <script type="text/javascript">
        ...
        function load_data() {
            $("#stu_tbody").fadeOut(1);
            var temp = "load_data.aspx?tb=comp";
            //alert(temp);
        ...
        function update(x) {
            var temp = "../Admin/load_data.aspx?req=compup&id=" + x;
            alert(temp);
            $.ajax({
                method: "GET",
                url: temp,
        ...
        function do_update() {
            ...
            var temp = "../Admin/load_data.aspx?update=comp&cid=" + cid + "&cn=" + cn + "&no=" + no + "&em=" + em + "&det=" + det + "&add=" + add + "&ct=" + ct + "&st=" + st;
            $.ajax({
                method: "GET",
                url: temp,
                success: function (data) {
        ...
        function do_delete(x) {
            var temp = "../Admin/load_data.aspx?delete=company&cid=" + x;
            alert(temp);
            $.ajax({
                method: "GET",
                url: temp,
...
<div class="m-subheader ">
	<div class="d-flex align-items-center">
 		<div class="mr-auto">
 			<h3 class="m-subheader__title ">Company Registration</h3>			
			 		</div>
  		<div>
	</div>
	</div>
